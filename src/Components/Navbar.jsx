            ...
            <div className='navcontainer'>
                <div className='leftcontent'>
                    ...
                    <select name="building" id="building">
                        <option value="StartBuilding">Start Building</option>
                    </select>
                    <span>Docs</span>
                    <span>Pricing</span>
                </div>
                <div className='rightcontent'>
                    <svg version="1.1" id="Layer_1" className='searchicon' xmlns="http://www.w3.org/2000/svg"
                        xmlnsXlink="http://www.w3.org/1999/xlink" x="0px" y="0px" width="122.879px" height="119.799px"
                        viewBox="0 0 122.879 119.799" enableBackground="new 0 0 122.879 119.799" xmlSpace="preserve">
                        <g>
                            <path
